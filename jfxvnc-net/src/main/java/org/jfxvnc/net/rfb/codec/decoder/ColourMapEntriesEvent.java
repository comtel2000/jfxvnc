...
public class ColourMapEntriesEvent implements ServerDecoderEvent {
  ...
  public ColourMapEntriesEvent(int firstColor, int numberOfColor, ByteBuf colors) {
  ...
  public String toString() {
    return "ColourMapEntries [firstColor=" + firstColor + ", numberOfColor=" + numberOfColor + ", colors.capacity=" + colors.capacity() + "]";
  }
}

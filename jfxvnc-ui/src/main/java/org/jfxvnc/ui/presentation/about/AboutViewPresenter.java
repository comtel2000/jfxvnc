...
public class AboutViewPresenter implements Initializable {
	...
	appendBuildLine(String.format("Version:\t%s (%s)", System.getProperty("java.runtime.version"),
		System.getProperty("java.vendor")));
	appendBuildLine(String.format("OS: \t%s (%s) %s", System.getProperty("os.name"), System.getProperty("os.arch"),
